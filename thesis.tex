...
\begin{figure}
  ...
  \end{subfigure}
  \caption{Example of localisation}
  \label{fig:localise}
\end{figure}
...
\section{Preprocessing}
First, we run preprocessor HQSpre on all benchmarks. Some of the benchmarks were solved immediately by this, therefore we removed these from  From this run, we saved all the resulting 

\begin{table}[]
\begin{tabular}{l|l|l|l|l|}
\cline{2-5}
                                  & \textbf{PEC} & \textbf{CSP} & \textbf{SAT} & \textbf{E19} \\ \hline
